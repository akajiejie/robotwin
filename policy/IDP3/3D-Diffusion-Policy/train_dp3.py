...
sys.path.append(os.path.join(DP3_ROOT, '3D-Diffusion-Policy', 'diffusion_policy_i3d'))
...
from diffusion_policy_i3d.policy.dp3 import DP3
from diffusion_policy_i3d.policy.idp3 import IDP3
from diffusion_policy_i3d.dataset.base_dataset import BaseDataset
from diffusion_policy_i3d.env_runner.base_runner import BaseRunner
from diffusion_policy_i3d.env_runner.robot_runner import RobotRunner
from diffusion_policy_i3d.common.checkpoint_util import TopKCheckpointManager
from diffusion_policy_i3d.common.pytorch_util import dict_apply, optimizer_to
from diffusion_policy_i3d.model.diffusion.ema_model import EMAModel
from diffusion_policy_i3d.model.common.lr_scheduler import get_scheduler
...
@hydra.main(
    ...
    config_path="diffusion_policy_i3d/config",
)
def main(cfg):
