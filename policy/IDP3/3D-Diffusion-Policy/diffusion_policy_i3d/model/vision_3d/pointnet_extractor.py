...
import diffusion_policy_i3d.model.vision_3d.point_process as point_process
...
class iDP3Encoder(nn.Module):
    def __init__(self, 
        ...
        if pointnet_type == "multi_stage_pointnet":
            ...
            self.extractor = MultiStagePointNetEncoder(out_channels=pointcloud_encoder_cfg.out_channels,use_pc_color=self.use_pc_color)
        else:
