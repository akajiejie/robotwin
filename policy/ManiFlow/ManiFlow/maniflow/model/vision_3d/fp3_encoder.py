...
from maniflow.model.vision_3d.point_process import fps_openpoint as fps
...
class PointcloudEncoder(nn.Module):
    def __init__(self, args = {
        ...
        self.return_cls = args['return_cls']  # whether to return the cls token
...
if __name__ == "__main__":
    ...
    pcd = torch.randn(2, 4096, 6)  # Batch of 2 point clouds with 1024 points each, each point has 6 features (x, y, z, r, g, b)
    output = encoder(pcd)
    print(output.shape)  # Should print: torch.Size([2, 512]) for embed_dim=512