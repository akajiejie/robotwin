...
if __name__ == '__main__':
    # test Dense Encoder
    data = torch.randn(2, 6, 2048)  # [B, C, N]
    encoder = PointNet2DenseEncoder(in_channels=6, out_channels=256, use_bn=True)
    output = encoder(data)
    print("Dense Encoder output shape:", output.shape)  # Should be [B, D, N]