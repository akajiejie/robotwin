...
from x_transformers.attend import Attend # pip install x-transformers
...
class JointAttention(Module):
    ...
    def forward(
        ...
        masks = default(masks, (None,) * len(inputs))
...
if __name__ == '__main__':
    ...
    print('single block')
    print('text tokens next', text_tokens_next.shape)
    print('image tokens next', image_tokens_next.shape)